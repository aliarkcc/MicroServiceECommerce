...
namespace CatalogService.Api.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(PaginatedItemsViewModel<CatalogItem>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<PaginatedItemsViewModel<CatalogItem>>> ItemsByTypeIdAndBrandIdAsync(int catalogTypeId, int? catalogBrandId, string name, [FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 0)
        {
            ...
            {
                root = root.Where(ci => ci.CatalogBrandId == catalogTypeId);
            }
        ...
        [ProducesResponseType((int)HttpStatusCode.NotFound)]
        public async Task<ActionResult> CreateProductAsync(int id)
        {
